...
function Scene_Credits(){
	...
	// add text
	var createdByText = new PIXI.Text(textStrings["createdBy"], {font: "46px 'KoPub Batang (Subset)'", fill:"#FFFFFF", align: "left"});
	...
	var authorText = new PIXI.Text(textStrings["NickyCase"], {font: "86px 'KoPub Batang (Subset)'", fill:"#FFFFFF", align: "left"});
	...
	var playtestersText = new PIXI.Text(textStrings["manyThanks"], {font: "44px 'KoPub Batang (Subset)'", fill:"#FFFFFF", align: "right"});
	...
	var supportersText1 = new PIXI.Text(textStrings["patreonSupporters"], {font: "45px 'KoPub Batang (Subset)'", fill:"#FFFFFF", align: "left"});
	...
	var supportersText2 = new PIXI.Text(textStrings["patreonSupporters"], {font: "45px 'KoPub Batang (Subset)'", fill:"#FFFFFF", align: "left"});
	...
	var supportersText3 = new PIXI.Text(textStrings["patreonSupporters"], {font: "45px 'KoPub Batang (Subset)'", fill:"#FFFFFF", align: "left"});
	...
	var supportersText4 = new PIXI.Text(textStrings["patreonSupporters"], {font: "45px 'KoPub Batang (Subset)'", fill:"#FFFFFF", align: "left"});
	...
	var thankYouText = new PIXI.Text(textStrings["thankYouForPlaying"], {font: "55px 'KoPub Batang (Subset)'", fill:"#FFFFFF", align: "center"});
	...
	var finallyText = new PIXI.Text(textStrings["lastButNotLeast"], {font: "37px 'KoPub Batang (Subset)'", fill:"#FFFFFF", align: "left"});
